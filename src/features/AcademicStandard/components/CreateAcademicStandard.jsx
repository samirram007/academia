...
const CreateAcademicStandard = () => {

    const campuses = useCampuses()
    const academicStandardMutation = useStoreAcademicStandardMutation()
    ...
    const formik = useFormik({
        ...
        validationSchema,
        onSubmit: values => {
            academicStandardMutation.mutate(values)
        },
...
export default CreateAcademicStandard