...
import { useStoreIncomeGroupMutation, useUpdateIncomeGroupMutation } from '../hooks/mutations';
...
const EntryForm = ({ initialValues, entryMode }) => {
    ...
    const handleFormSubmit = (values) => {
        if (entryMode === 'create') {
            incomeGroupStoreMutation.mutate(values)

        } else {

            incomeGroupUpdateMutation.mutate(values)
