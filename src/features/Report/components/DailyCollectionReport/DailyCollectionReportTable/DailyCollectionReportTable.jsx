    ...
    return (
        <div className='flex flex-col'>
            ...
            <div className="overflow-x-auto overflow-y-auto max-h-[55vh] 2xl:max-h-[68vh]">
                ...
                <div className='sticky bottom-0 border-t-2 border-slate-200 dark:border-slate-700'>
                            ...
                            {table.getFooterGroups().map(footerGroup => (
                                <tr key={footerGroup.id}>
                                    {footerGroup.headers.map(header => (
                                        <th
                                            key={header.id}
                                            className={`px-4 py-3 font-semibold text-slate-700 dark:text-slate-200 whitespace-nowrap ${header.column.columnDef.className || ''}`}
                                        >
                                            {header.isPlaceholder ? null : (
                                                flexRender(
                                                    header.column.columnDef.footer,
