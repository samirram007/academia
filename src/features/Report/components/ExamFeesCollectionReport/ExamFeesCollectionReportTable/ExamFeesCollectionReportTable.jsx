...
export default function ExamFeesCollectionReportTable({ data, columns, pageSize = 100, months,
                        ...
                        {table.getRowModel().rows.map(row => (
                            ...
                            <tr key={row.id} className='bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors'>
                                {row.getVisibleCells().map(cell => (
                                    ...
                                    <td key={cell.id} className={`px-4 py-2 text-slate-700 dark:text-slate-300 align-top ${cell.column.columnDef.className || ''}`}>
