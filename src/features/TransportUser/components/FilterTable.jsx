...
export default function FilterTable({ data, columns, pageSize = 10, createRoute,
    createForm, createFormTitle,
    mobileHeaders = ['id', 'name'], TransportUserData, initialFilterValues,setInitialFilterValues }) {
    ...
    return (
        <div className='container-flex md-container'>
            ...
            <div className={`flex`}>
                {
                    TransportUserData &&
                    <Filter TransportUserData={TransportUserData}
...
export const FilterButton = ({ showFilter, setShowFilter }) => {
    ...
    return (
        <button onClick={handleSwitchFilter}
            className={` btn btn-primary btn-sm text-xl     btn-rounded-symbol border-blue-300/10    `}>
            <TbFilterSearch />
        </button>
